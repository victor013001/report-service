...
public enum ServerResponses {
  ...
  SUCCESS_REGISTER_BOOTCAMP_REPORT("", 201, ConstantsMsg.SUCCESS_REGISTER_BOOTCAMP_REPORT_MSG),
  SUCCESS_UPDATE_USER_COUNT_FOR_BOOTCAMP_REPORT(
      "", 200, ConstantsMsg.SUCCESS_UPDATE_USER_COUNT_FOR_BOOTCAMP_REPORT_MSG);
